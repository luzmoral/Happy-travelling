...
<FlightManagementScreen>:
    ...
    BoxLayout:
        ...
        MDRaisedButton:
            ...
            on_release: app.show_province_form()
        MDRaisedButton:
...
class FlightListScreen(Screen):
    def on_departure_spinner_select(self, text):
        print("Provincia de partida seleccionada:", text)

    def on_destination_spinner_select(self, text):
        print("Destino seleccionado:", text)
    ...
    def search_flights(self, departure, destination):
        ...
        flight_data = [
    {"origin": "Cordoba", "destination": "Chaco", "price": "$500", "departure_time": "08:00 AM"},
    {"origin": "Buenos Aires", "destination": "Salta", "price": "$450", "departure_time": "10:30 AM"},
    {"origin": "Buenos Aires", "destination": "Cordoba", "price": "$600", "departure_time": "12:45 PM"},
]
        ...
        for flight in flight_data:
            flight_results_label.text += f"Origen: {flight['origin']}, Destino: {flight['destination']}, Precio: {flight['price']}\n"
...
# ...
    ...
    def show_date_picker(self):
        ...
        from kivy.uix.calendar import DatePicker
        ...
        popup.bind(on_dismiss=self.set_selected_date)
        popup.open()
